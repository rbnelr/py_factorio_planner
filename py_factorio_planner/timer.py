...
class Timer:
    ...
    def end(self):
        ...
        self.step_period = (self.end_ts -self.prev_ts) / freq
        self.full_period = (self.end_ts -self.begin_ts) / freq
    ...
    def step(self):
        ...
        self.step_period = (step_ts -self.prev_ts) / freq
    ...
    def get_time_since_step():
        ...
        return (now_ts -self.step_ts) / freq
    
    # time since begin() or prev step(), in seconds
    def get_time_since_begin():
        now_ts = get_timestamp()
        return (now_ts -self.begin_ts) / freq
